...
const ErrorAlert = () => {
	return (
		<Flex w="80%" bg="gray.600" p={50} alignItems="center" justifyContent="center">
			<Flex maxW="90%" w="full" mx="auto" bg={useColorModeValue('white', 'gray.800')} shadow="md" rounded="lg" overflow="hidden">
